...
<template>
  <label class="c-custom-checkbox">
    ...
    <span class="label text-base leading-5 font-light capitalize"><slot name="label" /></span>
    <span class="text-base leading-none font-light capitalize"><slot name="count" /></span>
  </label>
</template>
...
.label:hover svg path.fill {
  stroke: #6f64f8;
}

.c-custom-checkbox input[type="radio"]:checked + .label svg path.fill,
.c-custom-checkbox input[type="checkbox"]:checked + .label svg path.fill {
  stroke: #6f64f8;
}
</style>
